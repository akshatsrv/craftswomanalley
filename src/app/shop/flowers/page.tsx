...
const flowers = [
  { id: 1, name: "The Velvet Tulip", price: "₹499", image: "https://images.unsplash.com/photo-1589243064641-769d2141cb8e?q=80&w=800&auto=format&fit=crop", category: "Fuzzy Wire" },
  { id: 2, name: "Sun-Kissed Bloom", price: "₹599", image: "https://images.unsplash.com/photo-1597848212624-a19eb35e2651?q=80&w=800&auto=format&fit=crop", category: "Crochet" },
  { id: 3, name: "Lavender Soul", price: "₹449", image: "https://images.unsplash.com/photo-1565011523534-747a8601f10a?q=80&w=800&auto=format&fit=crop", category: "Fuzzy Wire" },
  { id: 4, name: "Rose Whisper", price: "₹649", image: "https://images.unsplash.com/photo-1548546738-9a57239377b7?q=80&w=800&auto=format&fit=crop", category: "Crochet" },
  { id: 5, name: "Morning Daisy", price: "₹399", image: "https://images.unsplash.com/photo-1560717789-0ac7c58ac90a?q=80&w=800&auto=format&fit=crop", category: "Fuzzy Wire" },
  { id: 6, name: "Ethereal Lily", price: "₹799", image: "https://images.unsplash.com/photo-1508784411316-02b8cd4d3a3a?q=80&w=800&auto=format&fit=crop", category: "Crochet" },
];
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
          {flowers.map((flower) => (
            <div key={flower.id} className="group flex flex-col">
              <div className="aspect-[4/5] premium-card premium-shadow bg-surface mb-6 relative overflow-hidden group">
                <div 
