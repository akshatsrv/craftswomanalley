      ...
      <main className="flex-grow">
        <section className="py-24 px-8 max-w-4xl mx-auto text-center space-y-12">
          ...
          <div className="font-sans text-lg text-foreground/70 leading-loose text-justify space-y-8 italic">
            <p>
              क्राफ्ट्सवुमन एली (CraftswomanAlley) केवल एक स्टोर नहीं, बल्कि उन हुनरमंद महिला शिल्पकारों का एक साझा मंच है जो अपनी उंगलियों के जादू से बेजान चीजों में जान फूंक देती हैं। हमारी यह 'गली' उन कलाकृतियों का एक सलीके से चुना हुआ संग्रह है, जिन्हें किसी फैक्ट्री की मशीन ने नहीं, बल्कि भारतीय कारीगरों की मेहनत और रूह के जज्बातों ने बनाया है।
            </p>
            <p>
